/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=../natbot/.dev.vars src/worker/env.d.ts` (hash: f696f3479cd3cf6dc4ce19846d0e9b3a)
// Runtime types generated with workerd@1.20260921.1 2026-09-15 nodejs_compat
interface __BaseEnv_Env {
	WRITING_INDEX: KVNamespace;
	WRITING: VectorizeIndex;
	CONNECT_LIMITER: RateLimit;
	MESSAGE_LIMITER: RateLimit;
	AI: Ai;
	HANDOFF_TO: "nathan@nathanarthur.com";
	SENTRY_DSN: "https://28b60ace403cfd26dd17ecba345c43b3@o4511632382558208.ingest.us.sentry.io/4512148291846144";
	TURNSTILE_SECRET_KEY: string;
	MAILGUN_API_KEY: string;
	ChatAgent: DurableObjectNamespace<import("./index").ChatAgent>;
	Budget: DurableObjectNamespace<import("./index").Budget>;
	HANDOFF_WORKFLOW: Workflow<Parameters<import("./index").HandoffWorkflow['run']>[0]['payload']>;
	INDEX_WORKFLOW: Workflow<Parameters<import("./index").WritingIndexWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "ChatAgent" | "Budget";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HANDOFF_TO" | "SENTRY_DSN" | "TURNSTILE_SECRET_KEY" | "MAILGUN_API_KEY">> {}
}
